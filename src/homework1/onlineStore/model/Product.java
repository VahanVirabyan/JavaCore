...
import homework1.onlineStore.model.enums.ProductType;
...
public class Product implements Serializable {
    ...
    public Product(String id, String name, String description, int stockQty, double price, ProductType productType, boolean isRemoved) {
        this.id = id;
        this.name = name;
