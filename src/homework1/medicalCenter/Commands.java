...
public interface Commands {
    ...
    static void printCommands() {
        ...
        System.out.println("Please input " + PRINT_ALL_PATIENTS_BY_DOCTOR  + " for PRINT_ALL_PATIENTS_BY_DOCTORS");
        System.out.println("Please input " + PRINT_TODAYS_PATIENTS + " for PRINT_TOODAYS_PATIENTS");
    }
}
